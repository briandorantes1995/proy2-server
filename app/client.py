...
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/Users/briandorantes/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    usuario: 'actions.UsuarioActions[models.Usuario]'
    empleado: 'actions.EmpleadoActions[models.Empleado]'
    tipohabitacion: 'actions.tipohabitacionActions[models.tipohabitacion]'
    habitaciones: 'actions.habitacionesActions[models.habitaciones]'
    ...
    def __init__(
        ...
        *,
        ...
        self.usuario = actions.UsuarioActions[models.Usuario](self, models.Usuario)
        self.empleado = actions.EmpleadoActions[models.Empleado](self, models.Empleado)
        self.tipohabitacion = actions.tipohabitacionActions[models.tipohabitacion](self, models.tipohabitacion)
        self.habitaciones = actions.habitacionesActions[models.habitaciones](self, models.habitaciones)
...
class Batch:
    usuario: 'UsuarioBatchActions'
    empleado: 'EmpleadoBatchActions'
    tipohabitacion: 'tipohabitacionBatchActions'
    habitaciones: 'habitacionesBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.usuario = UsuarioBatchActions(self)
        self.empleado = EmpleadoBatchActions(self)
        self.tipohabitacion = tipohabitacionBatchActions(self)
        self.habitaciones = habitacionesBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class tipohabitacionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class habitacionesBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
